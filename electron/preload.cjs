...
contextBridge.exposeInMainWorld('bar4bar', {
  ...
  youtubeLookup: (videoId) => ipcRenderer.invoke('youtube-lookup', videoId),
  ...
  alignModelStatus: () => ipcRenderer.invoke('align-model-status'),
  alignSetModel: (presetOrId) => ipcRenderer.invoke('align-set-model', presetOrId),
